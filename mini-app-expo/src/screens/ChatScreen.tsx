...
const MODE_OPTIONS: ModeOption[] = [
  ...
  { key: 'problem_solver', label: 'Solve' },
  { key: 'sim_explain', label: 'Sim' },
];
        ...
        {MODE_OPTIONS.map((option, index) => {
          ...
          return (
            <Pressable
              ...
              style={({ pressed }) => [
                styles.modeChip,
                index < MODE_OPTIONS.length - 1 ? styles.modeChipSpacing : null,
        ...
        ListEmptyComponent={
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyText}>
              Send a question and the AI will reply. Messages are saved locally.
            </Text>
          </View>
        }
        ListFooterComponent={
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <View style={styles.inputWrap}>
          <TextInput
            ...
            placeholder="Ask about electromagnetics..."
