...
**Slide**: 11-slide-multi-agent-system
**Type**: Content
**Layout**: agent-collaboration

**Narrative Goal**: Present the multi-agent collaboration system

**Content**:
- Title (in brackets, ALL CAPS): [Multi-agent协作系统]
- English Subtitle: Multi-agent System
...
**KEY QUOTE Box** (bottom): "多智能体协作，分工明确，协同高效"

**Visual Description**:
- Center: Three agent nodes arranged in triangle
- Each agent represented as distinct icon/character
- Collaboration arrows connecting agents
- Task flow indicators between agents
- Shared knowledge base in center
- Faded background: network patterns, collaboration symbols
- Clean technical illustration showing agent interactions
