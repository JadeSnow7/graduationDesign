...
在高校《电磁场》课程教学场景下，现有实现存在以下问题：

1. **概念抽象难以直观呈现**：电磁场理论涉及大量数学推导和三维空间概念，传统板书、PPT 难以有效传达空间分布与变化规律。
2. **答疑反馈不及时**：学生课后疑问依赖线下答疑或消息群，教师响应延迟大，难以覆盖所有学生。
3. **作业批改效率低**：电磁场作业通常涉及复杂推导，人工批改耗时长，反馈周期长。
...
- 调研发现，电磁场课程平均挂科率较高，学生普遍反映"概念抽象、公式难记"
- 教师反馈：每次作业批改约需 2-3 天，无法提供及时反馈
- 现有教学平台（如超星、雨课堂）缺乏 AI 答疑和电磁场仿真能力
...
3. **构建电磁场仿真可视化能力**：支持经典电磁场模型的参数化计算与交互式可视化
4. **保障系统性能与并发能力**：支持 100+ 学生同时在线签到/提交作业，AI 流式响应首字延迟 < 3s

### ❌ Non-Goals

1. **不做通用 LMS 系统**：专注电磁场课程场景，不追求覆盖所有学科
...
**原因**：纯 LLM 回答容易产生幻觉，电磁场专业知识需要准确性，RAG 可基于课程教材提供有据可查的回答。  
...
本项目构建了一个面向电磁场课程的智能教学平台，采用 **Go + Python 微服务架构**，实现了 **教学管理 + AI 辅助 + 仿真可视化** 的一体化能力。
